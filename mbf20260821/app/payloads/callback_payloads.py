...
# ==================================================
# SELL MODE / LIMIT ORDERS
# ==================================================


class SellModePayload(
    CallbackPayload,
    prefix="sell_mode"
):
    """
...
class OrdersPayload(
    ...
    """
    История ордеров (лимитные заявки)
    """
...
class DeleteOrderPayload(
    CallbackPayload,
    prefix="delete_order"
):
    """
    Удаление лимитной заявки
    """
