...
from database.stock.writer_stock_m10_clickhouse import (
    StockM10WriterClickHouse,
)
...
logger.info("START RUN STOCK M10")
...
if stocks_data:
    ...
    with ClickHouseClient() as client:
        ...
        writer = StockM10WriterClickHouse(
            stock_clickhouse,
        )
