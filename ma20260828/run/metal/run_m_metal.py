...
from database.metal.writer_metal_m_clickhouse import (
    MetalMWriterClickHouse,
)
...
if all_metals:
    ...
    logger.info(
        "START CLICKHOUSE INSERT TABLE=moex_api.moex_metal_m"
    )
