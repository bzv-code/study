...
from database.currency.writer_currency_h_clickhouse import (
    CurrencyHWriterClickHouse,
)
...
if all_currencies_h:
    ...
    with ClickHouseClient() as client:
        ...
        writer = CurrencyHWriterClickHouse(
