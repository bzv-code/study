...
from database.currency.writer_currency_m_clickhouse import (
    CurrencyMWriterClickHouse,
)
...
if all_currencies_m:
    ...
    with ClickHouseClient() as client:
        ...
        writer = CurrencyMWriterClickHouse(
