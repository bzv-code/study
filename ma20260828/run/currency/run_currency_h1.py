...
from database.currency.writer_currency_h1_clickhouse import (
    CurrencyH1WriterClickHouse,
)
...
if all_currencies_h1:
    ...
    with ClickHouseClient() as client:
        ...
        writer = CurrencyH1WriterClickHouse(
