...
from database.futures.writer_futures_candle_h1_clickhouse import (
...
if futures_data:
    ...
    with ClickHouseClient() as client:
        ...
        writer = FuturesCandleH1WriterClickHouse(
            futures_clickhouse
        )
...
logger.info(
    "RUN COMPLETE FUTURES CANDLE H1"
)
