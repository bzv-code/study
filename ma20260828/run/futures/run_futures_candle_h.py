...
from database.futures.writer_futures_candle_h_clickhouse import (
...
if futures_data:
    ...
    with ClickHouseClient() as client:
        ...
        writer = FuturesCandleHWriterClickHouse(
            futures_clickhouse
        )
