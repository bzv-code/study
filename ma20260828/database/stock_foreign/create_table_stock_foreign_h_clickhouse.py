# moex_api/database/stock_foreign/create_table_stock_foreign_h_clickhouse.py
...
TABLE_NAME = "moex_stock_foreign_h"
...
def main() -> None:
    ...
    Назначение:
        Недельные свечи зарубежных акций MOEX
    ...
    """
    print("=" * 80)
    print("CREATE CLICKHOUSE TABLE STOCK FOREIGN H")
    print("=" * 80)
