# moex_api/database/stock_foreign/create_table_stock_foreign_h1_clickhouse.py
...
TABLE_NAME = "moex_stock_foreign_h1"
...
def main() -> None:
    ...
    Назначение:
        Часовые свечи зарубежных акций MOEX
    ...
    """
    print("=" * 80)
    print("CREATE CLICKHOUSE TABLE STOCK FOREIGN H1")
    print("=" * 80)
