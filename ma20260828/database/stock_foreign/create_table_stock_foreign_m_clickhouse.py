# moex_api/database/stock_foreign/create_table_stock_foreign_m_clickhouse.py
...
TABLE_NAME = "moex_stock_foreign_m"
...
def main() -> None:
    ...
    Назначение:
        Месячные свечи зарубежных акций MOEX
    ...
    """
    print("=" * 80)
    print("CREATE CLICKHOUSE TABLE STOCK FOREIGN M")
    print("=" * 80)
