# moex_api/database/stock_foreign/create_table_stock_foreign_d_clickhouse.py
...
TABLE_NAME = "moex_stock_foreign_d"
...
def main() -> None:
    ...
    Назначение:
        Дневные свечи зарубежных акций MOEX
    ...
    """
    print("=" * 80)
    print("CREATE CLICKHOUSE TABLE STOCK FOREIGN D")
    print("=" * 80)
