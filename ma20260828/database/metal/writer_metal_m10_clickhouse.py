...
class MetalM10WriterClickHouse:
    """
    Загрузчик 10-минутных свечей металлов MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_metal_m10
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "MetalM10WriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        """
        Запись 10-минутных свечей чанками.
