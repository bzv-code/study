...
class MetalHWriterClickHouse:
    """
    Загрузчик недельных свечей металлов MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_metal_h
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "MetalHWriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        """
        Запись недельных свечей чанками.
