...
class MetalM1WriterClickHouse:
    """
    Загрузчик минутных свечей металлов MOEX
    в ClickHouse.
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "MetalM1WriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        """
        Запись минутных свечей чанками.
