...
class StockDWriterClickHouse:
    """
    Загрузчик дневных свечей акций MOEX
    в ClickHouse.
    ...
    TABLE_NAME = "moex_api.moex_stock_d"
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "StockDWriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        print("CLICKHOUSE INSERT STOCK D")
