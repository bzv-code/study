...
class StockH1WriterClickHouse:
    """
    Загрузчик часовых свечей акций MOEX
    в ClickHouse.

    Таблица:

        moex_api.moex_stock_h1
    ...
    TABLE_NAME = "moex_api.moex_stock_h1"
    ...
    def __init__(
        ...
        logger.debug(
            "StockH1WriterClickHouse initialized TABLE=%s",
            self.TABLE_NAME,
        )
    ...
    def write(
        ...
        print("=" * 80)
        print("CLICKHOUSE INSERT STOCK H1")
        print("=" * 80)
