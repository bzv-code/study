...
class IndexMWriterClickHouse:
    """
    Загрузчик месячных свечей индексов MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_index_m
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "IndexMWriterClickHouse initialized TABLE=%s",
    ...
    def _prepare_row(
        ...
        logger.debug(
            ...
            "PREPARE INDEX M ROW TICKER=%s DATE=%s",
    ...
    def write(
        ...
        """
        Запись месячных свечей индексов
        ...
        print("CLICKHOUSE INSERT INDEX M")
