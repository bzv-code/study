...
class IndexDWriterClickHouse:
    """
    Загрузчик дневных свечей индексов MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_index_d
    ...
    TABLE_NAME = "moex_api.moex_index_d"
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "IndexDWriterClickHouse initialized TABLE=%s",
    ...
    def _prepare_row(
        ...
        logger.debug(
            ...
            "PREPARE INDEX ROW TICKER=%s DATE=%s",
    ...
    def write(
        ...
        """
        Запись дневных свечей индексов
        ...
        print("CLICKHOUSE INSERT INDEX D")
