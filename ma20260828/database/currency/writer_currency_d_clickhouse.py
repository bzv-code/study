...
class CurrencyDWriterClickHouse:
    """
    Загрузчик дневных свечей валют MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_currency_d
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "CurrencyDWriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        print("CLICKHOUSE INSERT CURRENCY D")
