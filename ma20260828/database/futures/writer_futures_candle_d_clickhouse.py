...
class FuturesCandleDWriterClickHouse:
    """
    Загрузчик дневных свечей бессрочных фьючерсов MOEX
    в ClickHouse.
    ...
    Сектор:
        ...
        Передаётся из run_futures_candle_d.py.
    ...
    def write(
        ...
        """
        Запись дневных свечей фьючерса
        ...
        sector:
            ...
            Если передан из run_futures_candle_d.py,
        ...
        ВАЖНО:
            ...
            Регистр sector сохраняется без изменений.
        """
        ...
        if sector is None:
            ...
            # именно в том виде, как его указал вызывающий код.
            # --------------------------------------------------
        ...
        print(
            "CLICKHOUSE INSERT FUTURES CANDLE D"
        )
