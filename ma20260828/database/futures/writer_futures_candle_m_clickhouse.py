...
class FuturesCandleMWriterClickHouse:
    """
    Загрузчик месячных свечей бессрочных
    ...
    Сектор:
        ...
        Передаётся из run_futures_candle_m.py.
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "FuturesCandleMWriterClickHouse "
            "initialized TABLE=%s",
    ...
    def _parse_date(
        ...
        Для месячного таймфрейма сохраняется
        время начала месячной свечи.
        """
    ...
    def write(
        ...
        """
        Запись месячных свечей фьючерса
        ...
        candles:
            Список месячных свечей.

        sector:
            Сектор фьючерса.

            Если передан из
            run_futures_candle_m.py,
        ...
        if not candles:
            ...
            logger.warning(
                ...
                "NO FUTURES M CANDLES FOR INSERT "
                "TABLE=%s SECID=%s",
        ...
        print(
            "CLICKHOUSE INSERT FUTURES CANDLE M"
        )
        ...
        logger.debug(
            ...
            "FUTURES M CANDLE ROWS PREPARED "
        ...
        logger.debug(
            ...
            "EXISTING FUTURES M CANDLE KEYS "
            "SECID=%s COUNT=%s",
