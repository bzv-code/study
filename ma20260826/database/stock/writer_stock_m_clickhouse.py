...
class StockMWriterClickHouse:
    """
    Загрузчик месячных свечей акций MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_stock_m
    ...
    TABLE_NAME = "moex_api.moex_stock_m"
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "StockMWriterClickHouse initialized TABLE=%s",
