...
class StockM1WriterClickHouse:
    """
    Загрузчик минутных свечей акций MOEX
    в ClickHouse.

    Таблица:

        moex_api.moex_stock_m1
    ...
    TABLE_NAME = "moex_api.moex_stock_m1"
    ...
    def __init__(
        ...
        logger.debug(
            "StockM1WriterClickHouse initialized TABLE=%s",
            self.TABLE_NAME,
        )
    ...
    def write(
        ...
        print("=" * 80)
        print("CLICKHOUSE INSERT STOCK M1")
        print("=" * 80)
