...
class StockM10WriterClickHouse:
    """
    Загрузчик 10-минутных свечей акций MOEX
    в ClickHouse.

    Таблица:

        moex_api.moex_stock_m10
    ...
    TABLE_NAME = "moex_api.moex_stock_m10"
    ...
    def __init__(
        ...
        logger.debug(
            "StockM10WriterClickHouse initialized TABLE=%s",
            self.TABLE_NAME,
        )
    ...
    def write(
        ...
        """
        Запись 10-минутных свечей акций
        ...
        print("=" * 80)
        print("CLICKHOUSE INSERT STOCK M10")
        print("=" * 80)
