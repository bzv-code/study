...
class CurrencyM1WriterClickHouse:
    """
    Загрузчик минутных свечей валют MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_currency_m1
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "CurrencyM1WriterClickHouse initialized TABLE=%s",
    ...
    def _prepare_row(
        ...
        logger.debug(
            ...
            "PREPARE M1 ROW TICKER=%s DATE=%s",
    ...
    def write(
        ...
        print("CLICKHOUSE INSERT CURRENCY M1")
