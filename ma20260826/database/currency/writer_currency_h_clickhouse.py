...
class CurrencyHWriterClickHouse:
    """
    Загрузчик недельных свечей валют MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_currency_h
    ...
    TABLE_NAME = "moex_api.moex_currency_h"
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "CurrencyHWriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        print("CLICKHOUSE INSERT CURRENCY H")
