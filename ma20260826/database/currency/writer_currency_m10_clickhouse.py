...
class CurrencyM10WriterClickHouse:
    """
    Загрузчик 10-минутных свечей валют MOEX
    в ClickHouse.
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "CurrencyM10WriterClickHouse initialized TABLE=%s",
    ...
    def _prepare_row(
        ...
        logger.debug(
            ...
            "PREPARE M10 ROW TICKER=%s DATE=%s",
    ...
    def write(
        ...
        """
        Запись 10-минутных свечей валют
        ...
        print("CLICKHOUSE INSERT CURRENCY M10")
