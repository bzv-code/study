...
class CurrencyMWriterClickHouse:
    """
    Загрузчик месячных свечей валют MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_currency_m
    ...
    TABLE_NAME = "moex_api.moex_currency_m"
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "CurrencyMWriterClickHouse initialized TABLE=%s",
    ...
    def write(
        ...
        print("CLICKHOUSE INSERT CURRENCY M")
