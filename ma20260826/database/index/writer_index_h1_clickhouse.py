...
class IndexH1WriterClickHouse:
    """
    Загрузчик часовых свечей индексов MOEX
    в ClickHouse.

    Таблица:

        moex_api.moex_index_h1
    ...
    TABLE_NAME = "moex_api.moex_index_h1"
    ...
    def __init__(
        ...
        logger.debug(
            "IndexH1WriterClickHouse initialized TABLE=%s",
            self.TABLE_NAME,
        )
    ...
    def _prepare_row(
        ...
        logger.debug(
            "PREPARE INDEX H1 ROW TICKER=%s DATE=%s",
            item.ticker,
            item.date,
        )
    ...
    def write(
        ...
        """
        Запись часовых свечей индексов
        ...
        print("=" * 80)
        print("CLICKHOUSE INSERT INDEX H1")
        print("=" * 80)
