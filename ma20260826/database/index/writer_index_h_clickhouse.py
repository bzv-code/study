...
class IndexHWriterClickHouse:
    """
    Загрузчик недельных свечей индексов MOEX
    в ClickHouse.


    Таблица:

        moex_api.moex_index_h
    ...
    TABLE_NAME = "moex_api.moex_index_h"
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "IndexHWriterClickHouse initialized TABLE=%s",
    ...
    def _prepare_row(
        ...
        logger.debug(
            ...
            "PREPARE INDEX H ROW TICKER=%s DATE=%s",
    ...
    def write(
        ...
        """
        Запись недельных свечей индексов
        ...
        print("CLICKHOUSE INSERT INDEX H")
