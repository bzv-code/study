...
class IndexM1WriterClickHouse:
    """
    Загрузчик минутных свечей индексов MOEX
    в ClickHouse.

    Таблица:

        moex_api.moex_index_m1
    ...
    TABLE_NAME = "moex_api.moex_index_m1"
    ...
    def __init__(
        ...
        logger.debug(
            "IndexM1WriterClickHouse initialized TABLE=%s",
            self.TABLE_NAME,
        )
    ...
    def _prepare_row(
        ...
        logger.debug(
            "PREPARE INDEX M1 ROW TICKER=%s DATE=%s",
            item.ticker,
            item.date,
        )
    ...
    def write(
        ...
        """
        Запись минутных свечей индексов
        ...
        print("=" * 80)
        print("CLICKHOUSE INSERT INDEX M1")
        print("=" * 80)
