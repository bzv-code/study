...
class FuturesCandleM10WriterClickHouse:
    """
    Загрузчик 10-минутных свечей бессрочных
    фьючерсов MOEX в ClickHouse.

    Таблица:

        moex_api.moex_futures_candle_m10
    ...
    Сектор:
        ...
        Передаётся из run_futures_candle_m10.py.
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "FuturesCandleM10WriterClickHouse "
            "initialized TABLE=%s",
    ...
    def _parse_date(
        ...
        Для M10 сохраняется
        время начала 10-минутной свечи.
        """
    ...
    def _prepare_row(
        ...
        logger.debug(
            ...
            "PREPARE FUTURES CANDLE M10 ROW "
    ...
    def write(
        ...
        """
        Запись 10-минутных свечей фьючерса
        ...
        candles:
            Список 10-минутных свечей.

        sector:
            Сектор фьючерса.

            Если передан из
            run_futures_candle_m10.py,
        ...
        if not candles:
            ...
            logger.warning(
                ...
                "NO FUTURES M10 CANDLES FOR INSERT "
                "TABLE=%s SECID=%s",
        ...
        logger.info(
            ...
            "CLICKHOUSE FUTURES M10 CANDLES "
        ...
        print(
            "CLICKHOUSE INSERT FUTURES CANDLE M10"
        )
        ...
        logger.debug(
            ...
            "FUTURES M10 CANDLE ROWS PREPARED "
        ...
        logger.debug(
            ...
            "EXISTING FUTURES M10 CANDLE KEYS "
            "SECID=%s COUNT=%s",
