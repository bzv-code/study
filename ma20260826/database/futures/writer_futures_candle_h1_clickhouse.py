...
class FuturesCandleH1WriterClickHouse:
    """
    Загрузчик часовых свечей бессрочных
    фьючерсов MOEX в ClickHouse.

    Таблица:

        moex_api.moex_futures_candle_h1
    ...
    Сектор:
        ...
        Передаётся из run_futures_candle_h1.py.
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "FuturesCandleH1WriterClickHouse "
            "initialized TABLE=%s",
    ...
    def write(
        ...
        """
        Запись часовых свечей фьючерса
        ...
        candles:
            Список часовых свечей.

        sector:
            Сектор фьючерса.

            Если передан из
            run_futures_candle_h1.py,
        ...
        if not candles:
            ...
            logger.warning(
                ...
                "NO FUTURES H1 CANDLES FOR INSERT "
                "TABLE=%s SECID=%s",
        ...
        print(
            "CLICKHOUSE INSERT FUTURES CANDLE H1"
        )
        ...
        logger.debug(
            ...
            "FUTURES H1 CANDLE ROWS PREPARED "
        ...
        logger.debug(
            ...
            "EXISTING FUTURES H1 CANDLE KEYS "
            "SECID=%s COUNT=%s",
