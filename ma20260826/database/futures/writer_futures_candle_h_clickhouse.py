...
class FuturesCandleHWriterClickHouse:
    """
    Загрузчик недельных свечей бессрочных
    фьючерсов MOEX в ClickHouse.

    Таблица:

        moex_api.moex_futures_candle_h
    ...
    Сектор:
        ...
        Передаётся из run_futures_candle_h.py.
    ...
    def __init__(
        ...
        logger.debug(
            ...
            "FuturesCandleHWriterClickHouse "
            "initialized TABLE=%s",
    ...
    def _parse_date(
        ...
        Для недельного таймфрейма сохраняется
        время начала недельной свечи.
        """
    ...
    def write(
        ...
        """
        Запись недельных свечей фьючерса
        ...
        candles:
            Список недельных свечей.

        sector:
            Сектор фьючерса.

            Если передан из
            run_futures_candle_h.py,
        ...
        if not candles:
            ...
            logger.warning(
                ...
                "NO FUTURES H CANDLES FOR INSERT "
                "TABLE=%s SECID=%s",
        ...
        print(
            "CLICKHOUSE INSERT FUTURES CANDLE H"
        )
        ...
        logger.debug(
            ...
            "FUTURES H CANDLE ROWS PREPARED "
        ...
        logger.debug(
            ...
            "EXISTING FUTURES H CANDLE KEYS "
            "SECID=%s COUNT=%s",
