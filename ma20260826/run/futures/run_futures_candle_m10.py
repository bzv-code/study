...
from database.futures.writer_futures_candle_m10_clickhouse import (
...
if futures_data:
    ...
    with ClickHouseClient() as client:
        ...
        writer = FuturesCandleM10WriterClickHouse(
            futures_clickhouse
        )
    ...
    logger.info(
        "CLICKHOUSE M10 INSERT FINISHED"
    )
...
logger.info(
    "RUN COMPLETE FUTURES CANDLE M10"
)