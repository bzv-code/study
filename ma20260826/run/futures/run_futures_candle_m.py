...
from database.futures.writer_futures_candle_m_clickhouse import (
...
if futures_data:
    ...
    with ClickHouseClient() as client:
        ...
        writer = FuturesCandleMWriterClickHouse(
            futures_clickhouse
        )
    ...
    logger.info(
        "CLICKHOUSE M INSERT FINISHED"
    )

else:

    logger.warning(
        "NO FUTURES M DATA RECEIVED"
    )
