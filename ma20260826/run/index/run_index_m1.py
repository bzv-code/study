...
from database.index.writer_index_m1_clickhouse import (
    IndexM1WriterClickHouse,
)
...
logger.info("START RUN INDEX M1")
...
if all_indices:
    ...
    with ClickHouseClient() as client:
        ...
        writer = IndexM1WriterClickHouse(
            index_clickhouse,
        )
