...
from database.index.writer_index_m10_clickhouse import (
    IndexM10WriterClickHouse,
)
...
logger.info("START RUN INDEX M10")
...
if all_indices:
    ...
    with ClickHouseClient() as client:
        ...
        writer = IndexM10WriterClickHouse(
            index_clickhouse,
        )
