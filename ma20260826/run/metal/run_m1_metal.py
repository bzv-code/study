...
from database.metal.writer_metal_m1_clickhouse import (
    MetalM1WriterClickHouse,
)
...
DATE_TO = "2015-12-31"  # готов 2026 по "2026-07-31"
...
with MoexClient() as client:
    ...
    for secid in SECIDS:
        ...
        logger.info(
            "RECEIVED M1 DATA SECID=%s COUNT=%s",
            secid,
            len(prices),
        )
...
if all_metals:
    ...
    logger.info(
        "START CLICKHOUSE INSERT M1 METAL"
    )
    ...
    with ClickHouseClient() as client:
        ...
        metal_clickhouse = MetalClickHouse(
            client,
            table_name="moex_api.moex_metal_m1"
        )



        writer = MetalM1WriterClickHouse(
    ...
    logger.info(
        "CLICKHOUSE INSERT M1 METAL COMPLETE"
    )
