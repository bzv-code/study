...
from database.currency.writer_currency_m10_clickhouse import (
    CurrencyM10WriterClickHouse,
)
...
with MoexClient() as client:
    ...
    for secid in SECIDS:
        ...
        logger.info(
            ...
            "LOAD MOEX CURRENCY M10 SECID=%s",
...
if all_currencies_m10:
    ...
    with ClickHouseClient() as client:
        ...
        writer = CurrencyM10WriterClickHouse(
